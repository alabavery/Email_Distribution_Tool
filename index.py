...
file_management.ensure_data_exists(data_dir_path, 
									config.ADDRESSES_JSON_FILE_NAME, 
									config.SEEN_EMAIL_FILE_NAME, 
									config.CLIENT_SECRET_FILE_NAME, 
									config.CLIENT_SECRET)

# three lines below assume that csv file WILL NOT CHANGE after initial saving
...
both_fields_addresses = unused_addresses['both_fields']
one_field_addresses = unused_addresses['one_field_only']
